// pages/blog/comment-connaitre-surface-parcelle.js
...
export default function Article() {
  return (
    <>
      ...
      <div className="flex flex-col items-center px-4 py-16 max-w-2xl mx-auto text-left">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">
          Pourquoi la surface cadastrale est-elle importante ?
        </h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">
          Comment utiliser Surface-Terrain.fr ?
        </h2>
